...
public class ServiceMaps extends BaseServiceMaps{
    ...
    @Autowired
    private IExpertUserQuestionService iExpertUserQuestionService;
    ...
    @Autowired
    private IExpertServiceRelationService expertServiceRelationService;
    ...
    public void init(){
        ...
        serviceMap.put("expertuserquestion",iExpertUserQuestionService);
        ...
        serviceMap.put("expertService",expertServiceRelationService);
    }
