...
public class ExpertAppraiseController extends BaseController<IExpertAppraiseService> {
    ...
    @Override
    protected IExpertAppraiseService getMainService() {
        return expertAppraiseService;
    }
