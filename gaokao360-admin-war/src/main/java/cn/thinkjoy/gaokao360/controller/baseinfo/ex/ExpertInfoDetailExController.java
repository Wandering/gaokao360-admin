...
public class ExpertInfoDetailExController extends BaseController<IExpertInfoExService> {
     ...
     */
    @RequestMapping(value="/expertInfoDetail")
     ...
     * @return
     */
    @RequestMapping(value="/expertInfoDetails")
    @ResponseBody
    public BizData4Page findAllExpertInfoDetails(HttpServletRequest request,HttpServletResponse response){
