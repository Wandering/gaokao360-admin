...
public class ExpertServiceExController extends BaseController<IExpertInfoExService> {
     ...
     */
    @RequestMapping(value="/expertService")
    ...
    @Override
    protected IExpertServiceExService getMainService() {
        return expertServiceExService;
    }
