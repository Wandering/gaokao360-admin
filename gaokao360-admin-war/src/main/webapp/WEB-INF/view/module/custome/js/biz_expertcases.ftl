...
//      添加招办联系电话
        $("#addBtn").on(ace.click_event, function () {
            ...
            CommonFn.renderTextarea('#userComments');
            uploadFun();
        });
        ...
        var dialogHtml = ''
                ...
                + '<div class="form-group">'
                + '<label class="col-sm-2 control-label no-padding-right" for="userImgUrl"> 用户头像：</label>'
                + '<div class="col-sm-10">'
                ...
                + '<div class="form-group">'
                + '<label class="col-sm-2 control-label no-padding-right">  用户所在学校：</label>'
                + '<div class="col-sm-4">'
                + '<input type="text" class="form-control input-mask-phone" id="school" >'
                + '</div>'
                + '</div>'

                + '<div class="form-group">'
                + '<label class="col-sm-2 control-label no-padding-right">  服务类型：</label>'
                + '<div class="col-sm-4">'
                + '<select class="form-control" id="serviceId">'
                +   queryServiceTypeByExpert()
                + '</select>'
                + '</div>'
                + '</div>'

                + '<div class="form-group">'
                + '<label class="col-sm-2 control-label no-padding-right">  用户反馈：</label>'
                + '<div class="col-sm-10">'
                + '<div id="userComments" class="wysiwyg-editor"></div>'
                + '</div>'
                + '</div>'
        ...
        var addEditFun = function () {
            ...
            if (school == "") {
                CommonFn.tipsDialog('温馨提示', '请输入学校');
                return false;
            }
            if (userComments == "") {
                CommonFn.tipsDialog('温馨提示', '请输入反馈');
                return false;
            }
            if (serviceId == "00"){
                CommonFn.tipsDialog('温馨提示', '请选择服务');
                return false;
            }

            var addExpertCaseData = {
                oper: typeStr,
                expertId: expertId,
                userName: userName,
                userImgUrl: fileUrl,
