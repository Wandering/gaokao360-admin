 ...
 * $Id:  VideoCourseServiceImpl.java 2015-12-04 13:22:05 $
 */
...
import cn.thinkjoy.gaokao360.dao.ex.IGkPsychologyDAO;
...
public class GkPsychologyImpl extends AbstractPageService<IBaseDAO<VideoCourseDTO>, VideoCourseDTO> implements IGkPsychologyService<IBaseDAO<VideoCourseDTO>,VideoCourseDTO> {
    ...
    @Override
    public IBaseDAO<VideoCourseDTO> getDao() {
        return gkPsychologyDAO;
    }
