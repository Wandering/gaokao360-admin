...
import cn.thinkjoy.gaokao360.dao.ex.IScheduleExDAO;
...
import cn.thinkjoy.gaokao360.service.ex.IScheduleExService;
...
public class ScheduleExServiceImpl extends AbstractPageService<IBaseDAO<ScheduleDTO>, ScheduleDTO> implements IScheduleExService<IBaseDAO<ScheduleDTO>,ScheduleDTO> {
    ...
    @Override
    public IBaseDAO<ScheduleDTO> getDao() {
        return scheduleExDAO;
    }
